...
| TBD | Sender: chunking, pacing, retransmit scheduling | `src/sender/` |
| TBD | Receiver: bitmap, reassembly, NACK, md5, file write | `src/receiver/` |

`include/protocol.h` is the contract between the two code lanes. Frozen -
changing it is a group decision.
